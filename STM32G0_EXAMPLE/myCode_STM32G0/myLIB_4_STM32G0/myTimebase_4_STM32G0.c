...
#define  SYSTICK_CLK_DIV8  0 //STM32 systick support div/8
  ...
  #define  TIMEBASE_CLK  (SystemCoreClock /8) //Systick timer Clock = Sysclk/8 = 64000000/8 = 8000000 (by clear the SysTick_CTRL_TICKINT_Msk bit in SysTick->CTRL)
#else
  #define  TIMEBASE_CLK  (SystemCoreClock) //Systick timer Clock = Sysclk = 64000000
#endif
...
void myTimebase_init(void)
{
	...
	SysTick->CTRL = SysTick_CTRL_TICKINT_Msk
					#if(SYSTICK_CLK_DIV8 != 1)
		           | SysTick_CTRL_CLKSOURCE_Msk //SysTick_CTRL_CLKSOURCE_Msk: 1: SYSCLK, 0: SYSCLK/8 = 64000000 MHz /8 = 8MHz
					#endif
